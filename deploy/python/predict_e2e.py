...
from utility import get_image_file_list, check_and_read_gif, parse_args, draw_e2e_res
...
class TextE2E(object):
    def __init__(self, args):
        ...
        if self.engine=='Paddle':
            ...
            self.session, self.input_names, self.output_names = load_onnx_model(
                args, 'e2e')
...
if __name__ == "__main__":
    ...
    for image_file in image_file_list:
        ...
        src_im = draw_e2e_res(points, strs, image_file)
